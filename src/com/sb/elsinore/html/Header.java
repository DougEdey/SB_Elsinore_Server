...
public class Header implements Renderable {
    ...
    public void renderOn(HtmlCanvas htmlCanvas) throws IOException {
        htmlCanvas.head()
            ...
            .macros().javascript("/templates/static/jquery.js")
            ...
            .macros().javascript("/templates/static/jquery.flot.js")
            .macros().javascript("/templates/static/jquery.flot.axislabels.js")
            .macros().javascript("/templates/static/jquery.flot.time.js")
