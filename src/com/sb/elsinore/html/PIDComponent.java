...
public class PIDComponent implements Renderable {
    ...
    public void renderOn(HtmlCanvas html) throws IOException {
        ...
        html.div(
                ...
                ._script()
                .div(id(name + "-title").class_("title panel-heading").onClick(
                        "editDevice(this);"))
                ...
                .canvas(id(name + "-tempGauge").class_("gauge").width(300)
                        .height(140))._canvas().div(id(name + "-tempSummary"))
                .write(Messages.TEMPERATURE + "(").div(id("tempUnit"))
                .write("F")._div().write("): ").div(id(name + "-tempStatus"))
                .write("temp")._div().write("&#176", false).div(id("tempUnit"))
                .write("F")._div()._div();

        if (LaunchControl.recorderEnabled()) {
            html.div(
                id(name + "-graph_wrapper").class_(
                    "holo-content controller panel panel-info"))
            .div(id(name + "-graph_title")
