...
public class Mash {
    ...
    private Logger logger = LoggerFactory.getLogger(Mash.class);
    ...
    public void calcMashSchedule() {
        ...
        for (int i = 1; i < this.steps.size(); i++) {
            ...
            this.logger.info("Mash step Type: " + stp.type + " Method: " + stp.method);
            ...
            if (tMethod.equals(INFUSION)) { // calculate an infusion step
                ...
                this.logger.warn("Unrecognised mash step: " + stp.method);
            }
        ...
        // water use stats:
        this.logger.warn("Total weight: " + totalWeightLbs);
        ...
        this.logger.warn("Sparge Quarts: " + this.spargeQTS);
        ...
        this.logger.info("Collecting: %.2d mash water. Absorbed: %.2d. Loss: %.2d", col, mashWaterQTS, this.absorbedQTS,
                this.deadSpace.getValueAs(Quantity.QT));
        ...
        if (numSparge > 1) {
            ...
            batch_1_sparge_liters = (boil_size_l/<total number of steps> ) - mash_water_l + grain_wt_kg * 0.625)
		    	...
		    	*/
            this.logger.info("NumSparge: " + numSparge);

            this.logger.info("Collecting: " + col);
