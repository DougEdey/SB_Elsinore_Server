...
public class TemperatureTrigger implements TriggerInterface {
    ...
    public TemperatureTrigger(LaunchControl launchControl) {
        this.logger.info("Created an empty TemperatureModel Trigger with launchControl");
    ...
    public TemperatureTrigger(int position, String tempProbe, double targetTemp, String stepType, String stepMethod) {
        init(position, tempProbe, targetTemp, stepType, stepMethod);
    }

    public TemperatureTrigger(int position, String tempProbe, double targetTemp, String stepType, String stepMethod, LaunchControl launchControl) {
        this.launchControl = launchControl;
        init(position, tempProbe, targetTemp, stepType, stepMethod);
    }
...
//                    + "Trigger will wait for it to hit the target temperature.");
    ...
    public final void setActive() {
        this.active = true;
        createNotifications(Messages.TARGET_TEMP_TRIGGER, this.targetTemp,
...
//                        + "Cannot deactivate the PIDModel");
    ...
    private void createNotifications(String message, Object... args) {
        if (this.webNotification != null) {
            //Clear the existing notifications
            clearNotifications();
        }
        this.webNotification = new WebNotification();
        this.webNotification.setMessage(message);
    ...
    public void init(int position, String tempProbe, double targetTemp, String stepType, String stepMethod) {
