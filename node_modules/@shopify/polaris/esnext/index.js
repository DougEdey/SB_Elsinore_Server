...
import { Children, Component, Fragment, PureComponent, createElement, isValidElement } from 'react';
...
import { elementChildren, isElementOfType, wrapWithComponent } from '@shopify/react-utilities/components';
...
var styles$2 = {
  ...
  "colorWhite": "p_xs",
  "colorBlack": "p_ho",
  "colorSkyLighter": "p_cu",
  "colorSkyLight": "p_cs",
  "colorSky": "p_pz",
  "colorSkyDark": "p_cf",
  "colorInkLightest": "p_yk",
  "colorInkLighter": "p_dm",
  "colorInkLight": "p_n0",
  "colorInk": "p_jd",
  "colorBlueLighter": "p_vd",
  "colorBlueLight": "p_uh",
  "colorBlue": "p_uf",
  "colorBlueDark": "p_qt",
  "colorBlueDarker": "p_kj",
  "colorIndigoLighter": "p_xz",
  "colorIndigoLight": "p_q3",
  "colorIndigo": "p_hi",
  "colorIndigoDark": "p_oz",
  "colorIndigoDarker": "p_in",
  "colorTealLighter": "p_v9",
  "colorTealLight": "p_tp",
  "colorTeal": "p_w5",
  "colorTealDark": "p_t1",
  "colorTealDarker": "p_ii",
  "colorGreenLighter": "p_jp",
  "colorGreen": "p_w0",
  "colorGreenDark": "p_em",
  "colorYellowLighter": "p_aj",
  "colorYellow": "p_tr",
  "colorYellowDark": "p_q6",
  "colorOrange": "p_mi",
  "colorOrangeDark": "p_x3",
  "colorRedLighter": "p_zc",
  "colorRed": "p_lq",
  "colorRedDark": "p_u1",
  "colorPurple": "p_h7",
  "Svg": "p_yb",
...
function ButtonGroup$1({ children, segmented }) {
    const className = classNames(styles$6.ButtonGroup, segmented && styles$6.segmented);
...
var styles$7 = {
  ...
  "vertical": "p_qf",
  "spacingNone": "p_yw",
  "spacingExtraTight": "p_mn",
  "spacingTight": "p_r1",
  "spacingLoose": "p_mg",
  "spacingExtraLoose": "p_n3",
  "distributionLeading": "p_tt",
  "distributionTrailing": "p_fi",
  "distributionCenter": "p_eh",
  "distributionEqualSpacing": "p_sn",
  "distributionFill": "p_w1",
  "distributionFillEvenly": "p_tu",
  "alignmentLeading": "p_yq",
  "alignmentTrailing": "p_h3",
  "alignmentCenter": "p_fl",
  "alignmentFill": "p_ts",
  "alignmentBaseline": "p_ie",
  "Item-fill": "p_a3",
};
...
var styles$9 = {
  ...
  "Header": "p_bs",
  "Section": "p_wc",
  "Section-fullWidth": "p_wu",
  "Section-subdued": "p_ky",
  "SectionHeader": "p_bg",
  "Footer": "p_gt",
};
...
function Header({ children, actions }) {
    ...
    const childrenMarkup = isValidElement(children) ? children : createElement(
        Heading$1,
        null,
        children
    );
...
function Section({ children, title, subdued, fullWidth }) {
...
var styles$12 = {
  "variationPositive": "p_vr",
  "variationNegative": "p_gl",
  "variationStrong": "p_ta",
  "variationSubdued": "p_to",
};

function TextStyle$1({ variation, children }) {
    const className = classNames(variation && styles$12[variationName('variation', variation)]);
    return createElement(
        'span',
        { className: className },
        children
...
var styles$15 = {
  ...
  "statusSuccess": "p_b9",
  "statusInfo": "p_sw",
  "statusAttention": "p_hq",
  "statusWarning": "p_zy",
  "statusNew": "p_y8",
  "progressIncomplete": "p_h6",
  "progressPartiallyComplete": "p_um",
  "progressComplete": "p_dr",
};
...
function Item$2({ badge, content, url, onAction, icon, image, disabled, external, ellipsis }) {
  const className = classNames$1(styles$16.Item, disabled && styles$16.disabled);
...
function Choice$1({ id, label, error, children, labelHidden, helpText }) {
  const className = classNames(styles$21.Choice, labelHidden && styles$21.labelHidden);
  const labelMarkup = createElement(
    'label',
    { className: className, htmlFor: id },
    createElement(
      'span',
      { className: styles$21.Control },
      children
    ),
    createElement(
      'span',
  ...
  const helpTextMarkup = helpText ? createElement(
    'div',
    { className: styles$21.HelpText, id: helpTextID(id) },
    helpText
  ) : null;
  const errorMarkup = error && createElement(
    'div',
    { className: styles$21.Error, id: errorID(id) },
    createElement(
      'div',
      { className: styles$21.ErrorIcon },
  ...
  const descriptionMarkup = helpTextMarkup || errorMarkup ? createElement(
    'div',
    { className: styles$21.Descriptions },
    errorMarkup,
    helpTextMarkup
  ) : null;
...
function Checkbox$1({ id = getUniqueID(), label, labelHidden, helpText, checked = false, error, disabled, onChange, onFocus, onBlur, name, value }) {
    ...
    const wrapperClassName = classNames(styles$22.Checkbox, error && styles$22.error);
    ...
    const inputClassName = classNames(styles$22.Input, isIndeterminate && styles$22['Input-indeterminate']);
    return (
        ...
        createElement(
            ...
            createElement(
                ...
                createElement('span', { className: styles$22.Backdrop }),
                createElement(
                    'span',
                    { className: styles$22.Icon },
...
function RadioButton$1({ label, labelHidden, helpText, checked, disabled, onChange, onFocus, onBlur, id = getUniqueID$2(), name = id, value }) {
    ...
    return createElement(
        ...
        createElement(
            'span',
            { className: styles$23.RadioButton },
            createElement('input', { id: id, name: name, value: value, type: 'radio', checked: checked, disabled: disabled, className: styles$23.Input, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-describedby': describedBy }),
            createElement('span', { className: styles$23.Backdrop }),
            createElement('span', { className: styles$23.Icon })
        )
    );
}
...
function ChoiceList$1({ title, titleHidden, allowMultiple, choices, selected, onChange = noop, error, name = getUniqueID$1() }) {
    ...
    const className = classNames(styles$24.ChoiceList, titleHidden && styles$24.titleHidden);
    ...
    const choicesMarkup = choices.map(choice => {
        ...
        const children = choice.renderChildren ? createElement(
            'div',
            { className: styles$24.ChoiceChildren },
    ...
    const errorMarkup = error && createElement(
        'div',
        { className: styles$24.Error, id: getUniqueErrorID() },
        createElement(
            'div',
            { className: styles$24.ErrorIcon },
            createElement(Icon$2, { source: 'alert' })
        ),
        error
    );
...
class Collapsible$1 extends Component {
    ...
    render() {
        ...
        const wrapperClassName = classNames(styles$25.Collapsible, open && styles$25.open, animating && styles$25.animating);
...
class Slidable extends PureComponent {
    ...
    render() {
        ...
        return createElement(
            'div',
            { ref: this.setNode, className: styles$26.Slidable, onMouseDown: this.startDrag, onTouchStart: this.startDrag },
            endDragListener,
            moveListener,
            touchMoveListener,
            touchEndListener,
            touchCancelListener,
            createElement('div', { style: draggerPositioning, className: styles$26.Dragger, ref: this.setDraggerNode })
        );
    }
    setDraggerNode(node) {
...
class HuePicker extends PureComponent {
    ...
    render() {
        ...
        return createElement(
            'div',
            { className: styles$26.HuePicker, ref: this.setSliderHeight },
...
class AlphaPicker extends PureComponent {
    ...
    render() {
        ...
        return createElement(
            'div',
            { className: styles$26.AlphaPicker, ref: this.setSliderHeight },
            createElement('div', { className: styles$26.ColorLayer, style: { background } }),
            createElement(Slidable, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
        );
    }
    setSliderHeight(node) {
...
class ColorPicker$1 extends PureComponent {
    ...
    render() {
        ...
        return createElement(
            'div',
            { className: styles$26.ColorPicker, id: id },
            createElement(
                'div',
                { ref: this.setColorNode, className: styles$26.MainColor },
                createElement('div', { className: styles$26.ColorLayer, style: { backgroundColor: colorString } }),
...
class Item$3 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames(styles$27.Item, focused && styles$27['Item-focused'], position === Position.Primary ? styles$27['Item-primary'] : styles$27['Item-connection']);
        return createElement(
            'div',
...
var styles$28 = {
  ...
  "Cell-fixed": "p_dd",
  "Cell-truncated": "p_hf",
  "Cell-presentational": "p_pr",
  "Cell-header": "p_d8",
  "Cell-sortable": "p_ix",
  "Heading": "p_zh",
  "Heading-left": "p_t9",
  "Heading-sortable": "p_sk",
  "Cell-total": "p_zl",
  "Cell-footer": "p_qe",
};

function Cell({ height, content, contentType, fixed, truncate, presentational, header, total, footer, sorted, sortable, sortDirection, defaultSortDirection, polaris: { intl: { translate } }, onSort }) {
    const numeric = contentType === 'numeric';
    const className = classNames(styles$28.Cell, fixed && styles$28['Cell-fixed'], fixed && truncate && styles$28['Cell-truncated'], presentational && styles$28['Cell-presentational'], header && styles$28['Cell-header'], total && styles$28['Cell-total'], footer && styles$28['Cell-footer'], numeric && styles$28['Cell-numeric'], sorted && styles$28['Cell-sorted'], sortable && styles$28['Cell-sortable']);
    const style = height ? { height: `${height}px` } : undefined;
    const headerClassName = classNames(header && styles$28.Heading, header && contentType === 'text' && styles$28['Heading-left']);
    const iconClassName = classNames(sortable && styles$28['Heading-sortable']);
    // TODO work out a better way for fix this lint violation
    const presentationalMarkup = header ?
    // eslint-disable-next-line jsx-a11y/no-interactive-element-to-noninteractive-role
    createElement('th', { 'aria-hidden': true, role: 'presentation', className: className, style: style }) :
    // eslint-disable-next-line jsx-a11y/no-interactive-element-to-noninteractive-role
    createElement('td', { 'aria-hidden': true, role: 'presentation', className: className, style: style });
    let sortedIconMarkup = null;
    let sortableIconMarkup = null;
    let sortAccessibilityLabel;
    if (sortable) {
        // i18n string variable
        sortAccessibilityLabel = translate('Polaris.DataTable.sortAccessibilityLabel', { content: content.toLowerCase() });
        if (sorted) {
            const direction = sortDirection === 'ascending' ? 'Up' : 'Down';
            const source = `caret${direction}`;
            sortedIconMarkup = createElement(Icon$2, { source: source });
        } else {
            const direction = defaultSortDirection === 'ascending' ? 'Up' : 'Down';
            const source = `caret${direction}`;
            sortableIconMarkup = createElement(Icon$2, { source: source });
        }
    }
    const sortableHeadingContent = contentType === 'text' ? createElement(
        'span',
    ...
    const headingMarkup = header ? createElement(
        'th',
        Object.assign({ className: className, scope: 'col', style: style }, sortProps),
    ...
    const nonPresentationalMarkup = header || fixed ? headingMarkup : createElement(
        'td',
        { className: className, style: style },
        content
    );
    const cellMarkup = presentational ? presentationalMarkup : nonPresentationalMarkup;
    return cellMarkup;
}
function onKeyDownEnter(sortFunc) {
...
function Navigation({ currentColumn, columnVisibilityData, navigateTableLeft, navigateTableRight }) {
    const pipMarkup = columnVisibilityData.map((column, index) => {
        const className = classNames(styles$28.Pip, column.isVisible && styles$28['Pip-visible']);
        return createElement('div', { className: className, key: `pip-${index}` });
    });
    function reachedTableEnd(direction) {
        if (currentColumn) {
            return direction === 'left' ? currentColumn.isScrolledFarthestLeft : currentColumn.isScrolledFarthestRight;
        }
        return false;
    }
    return createElement(
        'div',
        { className: styles$28.Navigation },
        createElement(Button$2, { plain: true, icon: 'chevronLeft', disabled: reachedTableEnd('left'), accessibilityLabel: 'Scroll table left one column', onClick: navigateTableLeft }),
        pipMarkup,
        createElement(Button$2, { plain: true, icon: 'chevronRight', disabled: reachedTableEnd('right'), accessibilityLabel: 'Scroll table right one column', onClick: navigateTableRight })
    );
}
...
class DataTable$1 extends PureComponent {
    ...
    render() {
        const { headings, totals, rows, truncate, footerContent, sortable, defaultSortDirection = 'ascending', initialSortColumnIndex = 0 } = this.props;
        const { collapsed, columnVisibilityData, heights, currentColumn, sortedColumnIndex = initialSortColumnIndex, sortDirection = defaultSortDirection } = this.state;
        const className = classNames(styles$28.DataTable, collapsed && styles$28.collapsed, footerContent && styles$28.hasFooter);
        const wrapperClassName = classNames(styles$28.TableWrapper, collapsed && styles$28.collapsed);
        const footerClassName = classNames(footerContent && styles$28.TableFoot);
        ...
        const totalsMarkup = totals ? createElement(
            'tr',
            null,
            insertPresentationalCell(totals).map(this.renderTotals)
        ) : null;
        const headingMarkup = createElement(
            ...
            insertPresentationalCell(headings).map((heading, headingIndex) => {
                ...
                if (sortable) {
                    ...
                    const direction = isSorted && sortedColumnIndex === index ? sortDirection : 'none';
                ...
                return createElement(Cell$1, Object.assign({ header: true, key: id, height: height, content: heading, contentType: contentTypes[headingIndex], fixed: headingIndex === 0, truncate: truncate, presentational: headingIndex === 1 }, sortableHeadingProps));
            })
        );
        ...
        return createElement(
            'div',
            { className: wrapperClassName },
            createElement(Navigation, { currentColumn: currentColumn, columnVisibilityData: columnVisibilityData, navigateTableLeft: this.navigateTable('left'), navigateTableRight: this.navigateTable('right') }),
            createElement(
                'div',
                { className: className, ref: this.setDataTable },
                createElement(
                    'div',
                    { className: styles$28.ScrollContainer, ref: this.setScrollContainer, style: style },
                    ...
                    createElement(
                        'table',
                        { className: styles$28.Table, ref: this.setTable },
                        createElement(
                            'thead',
                            null,
                            headingMarkup,
    ...
    calculateColumnVisibilityData(collapsed) {
        if (collapsed) {
            ...
            return Object.assign({ columnVisibilityData }, getPrevAndCurrentColumns(tableData, columnVisibilityData));
        }
        return {
            columnVisibilityData: [],
    ...
    renderFirstTwoTotalsCells(index) {
        ...
        if (index === 0) {
            return createElement(Cell$1, { fixed: true, total: true, key: id, height: height, content: this.totalsRowHeading, truncate: truncate });
        }
        if (index === 1) {
            return createElement(Cell$1, { key: id, presentational: true, height: height });
        }
        return createElement(Cell$1, { total: true, key: id, contentType: 'numeric', height: height });
    }
    renderTotals(total, index) {
        ...
        return total === '' ? this.renderFirstTwoTotalsCells(index) : createElement(Cell$1, { total: true, key: id, height: height, contentType: 'numeric', content: total });
    }
    defaultRenderRow(row, index) {
        const className = classNames(styles$28.TableRow);
        const contentTypes = this.getContentTypes();
        ...
        return createElement(
            ...
            insertPresentationalCell(row).map((content, cellIndex) => {
                const id = `cell-${cellIndex}-row-${index}`;
                return createElement(Cell$1, { key: id, height: bodyCellHeights[index], content: content, contentType: contentTypes[cellIndex], fixed: cellIndex === 0, truncate: truncate, presentational: cellIndex === 1 });
            })
        );
    }
    renderFooter() {
        ...
        return createElement(Cell$1, { footer: true, height: footerCellHeight, content: this.props.footerContent, truncate: this.props.truncate });
    }
...
__decorate([autobind], DataTable$1.prototype, "getContentTypes", null);
__decorate([autobind], DataTable$1.prototype, "renderFirstTwoTotalsCells", null);
...
function insertPresentationalCell(arr = []) {
...
function measureColumn(tableData) {
    return function (column, index) {
        const { tableLeftVisibleEdge, tableRightVisibleEdge, firstVisibleColumnIndex, fixedColumnWidth } = tableData;
        ...
        const isCompletelyVisible = leftEdge < tableLeftVisibleEdge && rightEdge > tableRightVisibleEdge;
...
function isEdgeVisible(target$$1, start, end) {
    const minVisiblePixels = 30;
    return target$$1 >= start + minVisiblePixels && target$$1 <= end - minVisiblePixels;
}
function getPrevAndCurrentColumns(tableData, columnData) {
    ...
    const currentColumn = Object.assign({ isScrolledFarthestLeft: firstVisibleColumnIndex === 0 && tableLeftVisibleEdge === 0, isScrolledFarthestRight: lastColumn.rightEdge <= tableRightVisibleEdge }, columnData[firstVisibleColumnIndex]);
...
class Day extends PureComponent {
    ...
    render() {
        ...
        if (!day) {
            return createElement('div', { className: styles$29.EmptyDay, onMouseOver: handleHover });
        }
        const handleClick = onClick && !disabled ? onClick.bind(null, day) : noop;
        const today = isSameDay(new Date(), day);
        const className = classNames(styles$29.Day, selected && styles$29['Day-selected'], disabled && styles$29['Day-disabled'], today && styles$29['Day-today'], (inRange || inHoveringRange) && !disabled && styles$29['Day-inRange']);
...
function Weekday({ label, title, current }) {
    const className = classNames(styles$29.Weekday, current && styles$29['Weekday-current']);
    return createElement(
        'div',
...
function Month({ focusedDate, selected, hoverDate, disableDatesBefore, disableDatesAfter, allowRange, onChange = noop, onHover = noop, onFocus = noop, month, year, weekStartsOn }) {
    const isInHoveringRange = allowRange ? hoveringDateIsInRange : () => false;
    const now = new Date();
    const current = now.getMonth() === month && now.getFullYear() === year;
    const className = classNames(styles$29.Title, current && styles$29['Month-current']);
    const weeks = getWeeksForMonth(month, year, weekStartsOn);
    const weekdays = getWeekdaysOrdered(weekStartsOn).map(weekday => createElement(Weekday, { key: weekday, title: abbreviationForWeekday(weekday), current: current && new Date().getDay() === weekday, label: weekday }));
    ...
    function renderWeek(day, dayIndex) {
        if (day == null) {
            ...
            return (
                // eslint-disable-next-line react/jsx-no-bind
                createElement(Day$1, { key: dayIndex, onHover: onHover.bind(null, lastDayOfMonth) })
            );
        }
        ...
        return createElement(Day$1, { focused: focusedDate != null && isSameDay(day, focusedDate), day: day, key: dayIndex, onFocus: onFocus, onClick: handleDateClick, onHover: onHover, selected: selected != null && dateIsSelected(day, selected), inRange: selected != null && dateIsInRange(day, selected), disabled: disabled, inHoveringRange: selected != null && hoverDate != null && isInHoveringRange(day, selected, hoverDate) });
    }
    const weeksMarkup = weeks.map((week, index) => createElement(
        'div',
        { role: 'row', className: styles$29.Week, key: index },
        week.map(renderWeek)
    ));
    return createElement(
        'div',
        { role: 'grid', className: styles$29.Month },
        createElement(
            'div',
            { className: className },
            Months[month],
        ...
        createElement(
            'div',
            { role: 'rowheader', className: styles$29.WeekHeadings },
            weekdays
        ),
        weeksMarkup
    );
...
class DatePicker$1 extends PureComponent {
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (range != null && prevState.range != null && isSameDay(range.start, prevState.range.start) && isSameDay(range.end, prevState.range.end)) {
            return null;
        }
        return {
            range,
    ...
    render() {
        const { id, month, year, allowRange, multiMonth, disableDatesBefore, disableDatesAfter, weekStartsOn = Weekdays.Sunday, polaris: { intl } } = this.props;
        ...
        return createElement(
            'div',
            { id: id, className: styles$29.DatePicker, onKeyDown: handleKeyDown, onKeyUp: this.handleKeyUp },
            createElement(
                'div',
                { className: styles$29.Header },
            ...
            createElement(
                'div',
                { className: styles$29.MonthContainer },
...
function DescriptionList$1({ items }) {
    const terms = items.reduce((allTerms, { term, description }) => [...allTerms, createElement(
        'dt',
        { key: getUniqueTermKey(), className: styles$30.Term },
        term
    ), createElement(
        'dd',
        { key: getUniqueDescriptionKey(), className: styles$30.Description },
        description
    )], []);
    return createElement(
        'dl',
        { className: styles$30.DescriptionList },
        terms
    );
}
...
function DisplayText$1({ element: Element = 'p', children, size = 'medium' }) {
    const className = classNames(styles$31.DisplayText, size && styles$31[variationName('size', size)]);
    return createElement(
        Element,
        { className: className },
        children
...
function Link$2({ url, children, onClick, external, id }) {
  return url ? createElement(
    UnstyledLink$2,
    { onClick: onClick, className: styles$32.Link, url: url, external: external, id: id },
    children
  ) : createElement(
    'button',
    { onClick: onClick, className: styles$32.Link, id: id },
    children
  );
}
...
class FileUpload$1 extends Component {
    ...
    render() {
        ...
        const { actionTitle, actionHint } = this.state;
        const imageClasses = classNames(styles$33.Image, size && size === 'extraLarge' && styles$33.sizeExtraLarge, size && size === 'large' && styles$33.sizeLarge);
        ...
        return createElement(
            'div',
            { className: styles$33.FileUpload },
            smallView,
            mediumView,
            largeView,
            extraLargeView
...
class DropZone$1 extends Component {
    ...
    render() {
        ...
        const { children, disabled, outline, accept, active, overlay, allowMultiple } = this.props;
        ...
        const classes = classNames(styles$34.DropZone, outline && styles$34.hasOutline, (active || dragging) && styles$34.isDragging, error && styles$34.hasError, size && size === 'extraLarge' && styles$34.sizeExtraLarge, size && size === 'large' && styles$34.sizeLarge, size && size === 'medium' && styles$34.sizeMedium, size && size === 'small' && styles$34.sizeSmall);
        const dragOverlay = (active || dragging) && !error && overlay ? createElement(
            'div',
            { className: styles$34.Overlay },
            createElement(
                Stack$1,
                { vertical: true, spacing: 'tight' },
...
class EmptySearchResult$1 extends PureComponent {
    render() {
        ...
        const illustrationMarkup = withIllustration ? createElement(Image$1, { alt: altText, source: emptySearch, className: styles$35.Image, draggable: false }) : null;
        return createElement(
            Stack$1,
...
class EmptyState$1 extends PureComponent {
  render() {
    ...
    const className = classNames(styles$36.EmptyState, imageContained && styles$36.imageContained);
    const imageMarkup = largeImage ? createElement(Image$1, { alt: '', role: 'presentation', className: styles$36.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : createElement(Image$1, { role: 'presentation', alt: '', className: styles$36.Image, source: image });
    const secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
    return createElement(
      'div',
      { className: className },
      createElement(
        'div',
        { className: styles$36.Section },
        createElement(
          'div',
          { className: styles$36.DetailsContainer },
          createElement(
            'div',
            { className: styles$36.Details },
            createElement(
              TextContainer$1,
              null,
              createElement(
              ...
              createElement(
                'div',
                { className: styles$36.Content },
                children
              )
            ),
            createElement(
              'div',
              { className: styles$36.Actions },
              createElement(
                ButtonGroup$1,
                null,
        ...
        createElement(
          'div',
          { className: styles$36.ImageContainer },
          imageMarkup
        )
      )
    );
...
function ExceptionList$1({ items: itemsList }) {
  const items = itemsList.map((item, index) => {
    ...
    const itemClasses = classNames(styles$38.Item, status && styles$38[variationName('status', status)]);
    const iconMarkup = icon ? createElement(Icon$2, { source: icon }) : createElement('span', { className: styles$38.Bullet });
    const titleMarkup = title && createElement(
      'span',
      { className: styles$38.Title },
      title
    );
    const descriptionMarkup = description && createElement(
      'span',
      { className: styles$38.Description },
      description
    );
  ...
  return createElement(
    'ul',
    { className: styles$38.ExceptionList },
    items
  );
}
...
function FooterHelp$1({ children }) {
  return createElement(
    'div',
    { className: styles$39.FooterHelp },
    createElement(
      'div',
...
class Form$1 extends PureComponent {
    render() {
        ...
        const submitMarkup = implicitSubmit && createElement('button', { type: 'submit', className: styles$40.submit, 'aria-hidden': 'true' });
        return createElement(
            'form',
...
function Group({ children, condensed, title, helpText }) {
    const className = classNames(condensed && styles$41.condensed);
    ...
    if (helpText) {
        ...
        helpTextElement = createElement(
            'div',
            { id: helpTextID, className: styles$41.HelpText },
            helpText
        );
    }
    if (title) {
        ...
        titleElement = createElement(
            'div',
            { id: titleID, className: styles$41.Title },
            title
        );
    }
...
class FormLayout$1 extends PureComponent {
    render() {
        ...
        return createElement(
            'div',
            { className: styles$41.FormLayout },
...
function KeyboardKey$1({ children }) {
    ...
    return createElement(
        'kbd',
        { className: styles$42.KeyboardKey },
        key
    );
}
...
function Label$1({ children, id, hidden }) {
    const className = classNames(styles$43.Label, hidden && styles$43.hidden);
    return createElement(
        'div',
        { className: className },
        createElement(
            'label',
            { id: labelID(id), htmlFor: id, className: styles$43.Text },
            children
        )
    );
}
...
var styles$45 = {
  "Layout": "p_gu",
  "Section": "p_lf",
  "Section-secondary": "p_oi",
  "Section-fullWidth": "p_b8",
  "AnnotatedSection": "p_e4",
  "AnnotationWrapper": "p_ab",
  "AnnotationContent": "p_f0",
  "Annotation": "p_m9",
  "AnnotationDescription": "p_gq",
};
...
const scaleInClasses = {
  enter: classNames(styles$47.animateScaleIn, styles$47.entering),
  enterActive: classNames(styles$47.animateScaleIn, styles$47.entered),
  exit: classNames(styles$47.animateScaleIn, styles$47.exiting),
  exitActive: classNames(styles$47.animateScaleIn, styles$47.exited)
};
function ScaleIn(_a) {
  var { children } = _a,
      props = __rest(_a, ["children"]);
  return createElement(
    CSSTransition,
    Object.assign({}, props, { classNames: scaleInClasses }),
    children
  );
}
...
function Header$2({ id, children, onClose }) {
  const handleClose = memoizedBind$1(onClose);
  return createElement(
    'div',
    { className: styles$48.Header },
    createElement(
      Stack$1,
      { alignment: 'center' },
      createElement(
...
function CloseButton({ title = true, onClick }) {
    const className = classNames$1(styles$48.CloseButton, !title && styles$48.withoutTitle);
    return createElement(
        'button',
...
function Section$4({ children, flush = false, subdued = false }) {
    const className = classNames(styles$49.Section, flush && styles$49.flush, subdued && styles$49.subdued);
    return createElement(
        'section',
        { className: className },
        children
...
function Footer$1({ primaryAction, secondaryActions, children }) {
  ...
  return createElement(
    'div',
    { className: styles$50.Footer },
    createElement(
      'div',
      { className: styles$50.FooterContent },
      createElement(
        Stack$1,
        { alignment: 'center' },
        createElement(
...
const getUniqueID$4 = createUniqueIDFactory('modal-header');
class Modal$2 extends Component {
    ...
    render() {
        ...
        const { children, onClose, title, src, open, instant, sectioned, loading, large, limitHeight, footer, primaryAction, secondaryActions, polaris: { intl } } = this.props;
        ...
        if (open) {
            ...
            const bodyMarkup = src ? createElement('iframe', { title: iframeTitle, src: src, className: styles$51.IFrame, onLoad: this.handleIFrameLoad, style: { height: `${iframeHeight}px` } }) : createElement(
                Scrollable$2,
...
class Option$1 extends Component {
    ...
    render() {
        ...
        const { focused } = this.state;
        const className = classNames(styles$52.SingleSelectOption, focused && styles$52.focused, disabled && styles$52.disabled, select && styles$52.select);
        const optionMarkup = allowMultiple ? createElement(
            'label',
            { htmlFor: id, className: styles$52.Label },
            createElement(
                'div',
                { className: styles$52.Checkbox },
                createElement(Checkbox$4, { id: id, value: value, checked: select, disabled: disabled, onChange: this.handleClick })
            ),
            label
        ) : createElement(
            'button',
            { type: 'button', className: className, onClick: this.handleClick, disabled: disabled, onFocus: this.toggleFocus, onBlur: this.toggleFocus },
            label
        );
        return createElement(
            'li',
            { key: id, className: styles$52.Option, tabIndex: -1 },
            optionMarkup
        );
    }
    handleClick() {
...
const getUniqueID$5 = createUniqueIDFactory('Checkbox');
function Checkbox$4({ id = getUniqueID$5(), checked = false, disabled, onChange, name, value }) {
  return createElement(
    'div',
    { className: styles$53.Checkbox },
    createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$53.Input, 'aria-checked': checked, onChange: onChange }),
...
class OptionList$1 extends Component {
    ...
    render() {
        ...
        const optionsMarkup = optionsExist ? normalizedOptions.map(({ title, options }, sectionIndex) => {
            const titleMarkup = title ? createElement(
                'p',
                { className: styles$54.Title },
                title
            ) : null;
            const optionsMarkup = options && options.map((option, optionIndex) => {
                const isSelected = selected.includes(option.value);
                const id = `${this.id}-${sectionIndex}-${optionIndex}`;
                return createElement(Option$1, Object.assign({}, option, { key: id, id: id, section: sectionIndex, index: optionIndex, onClick: this.handleClick, select: isSelected, allowMultiple: allowMultiple }));
            });
            return createElement(
                'li',
  ...
  render() {
    ...
    return (
      ...
      createElement(
        ...
        createElement(
          UnstyledLink$2,
          { key: content, url: url, className: styles$55.Breadcrumb, onMouseUp: handleMouseUpByBlurring },
          createElement(
            'span',
            { className: styles$55.Icon },
...
function Pagination$1({ hasNext, hasPrevious, nextURL, previousURL, onNext, onPrevious, plain, accessibilityLabel, polaris: { intl } }) {
  let label;
  if (accessibilityLabel) {
    label = accessibilityLabel;
  } else {
  ...
  const className = classNames$1(styles$56.Pagination, plain && styles$56.plain);
  const previousButton = previousURL ? createElement(
    UnstyledLink$2,
    { className: styles$56.Button, url: previousURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.previous') },
    createElement(Icon$2, { source: 'arrowLeft' })
  ) : createElement(
    'button',
    { onClick: onPrevious, onMouseUp: handleMouseUpByBlurring, className: styles$56.Button, 'aria-label': intl.translate('Polaris.Pagination.previous'), disabled: !hasPrevious },
    createElement(Icon$2, { source: 'arrowLeft' })
  );
  const nextButton = nextURL ? createElement(
    UnstyledLink$2,
    { className: styles$56.Button, url: nextURL, onMouseUp: handleMouseUpByBlurring, 'aria-label': intl.translate('Polaris.Pagination.next') },
    createElement(Icon$2, { source: 'arrowRight' })
  ) : createElement(
    'button',
    { onClick: onNext, onMouseUp: handleMouseUpByBlurring, className: styles$56.Button, 'aria-label': intl.translate('Polaris.Pagination.next'), disabled: !hasNext },
    createElement(Icon$2, { source: 'arrowRight' })
  );
  return createElement(
    'nav',
...
const getUniqueID$7 = createUniqueIDFactory('portal-');
class Portal$1 extends PureComponent {
    constructor() {
        super(...arguments);
        this.portalId = this.props.idPrefix !== '' ? `${this.props.idPrefix}-${getUniqueID$7()}` : getUniqueID$7();
    }
    componentWillMount() {
        if (isServer) {
            return;
...
var styles$59 = {
  ...
  "measuring": "p_bu",
  "exiting": "p_wd",
  "positionedAbove": "p_ut",
  "Tip": "p_p0",
  "Wrapper": "p_pd",
  "Content-fullHeight": "p_iy",
  "Pane": "p_ok",
  "Pane-fixed": "p_lm",
  "Section": "p_nf",
  "FocusTracker": "p_g8",
...
function Section$5({ children }) {
    return createElement(
        'div',
        { className: styles$59.Section },
        children
    );
}

function Pane({ fixed, sectioned, children }) {
    const className = classNames(styles$59.Pane, fixed && styles$59['Pane-fixed']);
    const content = sectioned ? wrapWithComponent(children, Section$5) : children;
...
class PopoverOverlay extends PureComponent {
    ...
    renderPopover(transitionStatus, overlayDetails) {
        ...
        const className = classNames(styles$59.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$59.positionedAbove, fullWidth && styles$59.fullWidth, measuring && styles$59.measuring);
        this.transitionStatus = transitionStatus;
        const tipMarkup = !measuring ? createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$59.Tip }) : null;
        const contentStyles = measuring ? undefined : { height: desiredHeight };
        const contentClassNames = classNames(styles$59.Content, fullHeight && styles$59['Content-fullHeight']);
        const content = createElement(
            'div',
            { id: id, tabIndex: -1, className: contentClassNames, style: contentStyles, ref: this.setContentNode },
        ...
        return createElement(
            ...
            tipMarkup,
            createElement('div', { className: styles$59.FocusTracker
                // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
    ...
    handleClick(event) {
        ...
        const isDescendant = contentNode != null && nodeContainsDescendant(contentNode, target$$1);
...
function animationVariations(status) {
    switch (status) {
        case 'exiting':
            return styles$59.exiting;
        default:
            return null;
    }
}

const getUniqueID$6 = createUniqueIDFactory('Popover');
...
var styles$60 = {
  ...
  "Content": "p_d2",
  "Header": "p_a4",
  "Header-hasPagination": "p_cn",
  "Header-hasBreadcrumbs": "p_se",
  "Header-hasSecondaryActions": "p_ac",
  "Header-hasSeparator": "p_t7",
  "Header-hasRollup": "p_sv",
  "IndividualActions": "p_yz",
  "Rollup": "p_i3",
  "Navigation": "p_ft",
  "Pagination": "p_z5",
  "MainContent": "p_hr",
  "TitleAndActions": "p_uo",
  "Title": "p_yv",
  "Title-hidden": "p_ru",
  "Actions": "p_gn",
  "SecondaryActions": "p_i1",
  "Action": "p_xk",
  "ActionGroup": "p_nq",
  "PrimaryAction": "p_ik",
  "ActionIcon": "p_sj",
...
function Action({ icon, url, external, onAction, children, disclosure, accessibilityLabel, disabled, showIndicator, hasIndicator }) {
  const iconMarkup = icon ? createElement(
    'span',
    { className: styles$60.ActionIcon },
    createElement(Icon$2, { source: icon })
  ) : null;
  const disclosureIconMarkup = disclosure ? createElement(
    'span',
  ...
  const contentMarkup = iconMarkup || disclosureIconMarkup ? createElement(
    'span',
    { className: styles$60.ActionContent },
    iconMarkup,
    createElement(
      'span',
      null,
  ...
  if (url) {
    return createElement(
      UnstyledLink$2,
      { key: children, external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$60.Action, 'aria-label': accessibilityLabel },
      contentMarkup
    );
  }
  const indicatorMarkup = false && showIndicator && !hasIndicator && createElement(Indicator$1, null);
  const className = classNames$1(styles$60.Action, disabled && styles$60.disabled, icon && children == null && styles$60.iconOnly, false && showIndicator && styles$60['Action-outline']);
  return createElement(
    'button',
...
class Header$3 extends PureComponent {
    constructor() {
        super(...arguments);
        this.state = {
            rollupOpen: false
    ...
    render() {
        ...
        const className = classNames(styles$60.Header, titleHidden && styles$60['Title-hidden'], pagination && styles$60['Header-hasPagination'], separator && styles$60['Header-hasSeparator'], breadcrumbs && breadcrumbs.length && styles$60['Header-hasBreadcrumbs'], this.hasRollup && styles$60['Header-hasRollup'], secondaryActions && secondaryActions.length && styles$60['Header-hasSecondaryActions']);
        ...
        return primaryActionMarkup ? createElement(
            ...
            createElement(
                'div',
                { className: styles$60.MainContent },
                createElement(
                    'div',
                    { className: styles$60.TitleAndActions },
                    titleMarkup,
                    actionsMarkup
                ),
                primaryActionMarkup
    ...
    renderSecondaryActions() {
        ...
        const actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(({ title, icon, actions, details }) => {
            const detailsClassName = classNames(styles$60.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$60.withActions);
            const detailsMarkup = details ? createElement(
                'div',
            ...
            return createElement(
                'div',
                { className: styles$60.ActionGroup, key: `ActionGroup-${title}` },
                createElement(
                    Popover$1,
        ...
        return createElement(
            'div',
            { className: styles$60.SecondaryActions },
            rollupMarkup,
            createElement(
                'div',
                { className: styles$60.IndividualActions },
                secondaryActionMarkup,
                actionGroupsMarkup
            )
        );
...
__decorate([autobind], Header$3.prototype, "handleRollupToggle", null);
...
class Page$1 extends PureComponent {
    ...
    render() {
        ...
        const className = classNames(styles$60.Page, fullWidth && styles$60.fullWidth, singleColumn && styles$60.singleColumn);
        const headerMarkup = this.props.polaris.easdk || !this.hasHeaderContent() ? null : createElement(Header$3, rest);
        return createElement(
            'div',
            { className: className },
            headerMarkup,
...
function PageActions$1({ primaryAction, secondaryActions }) {
  ...
  return createElement(
    'div',
    { className: styles$61.PageActions },
    createElement(
      Stack$1,
...
const getUniqueID$8 = createUniqueIDFactory('RangeSlider');
...
class RangeSlider$1 extends PureComponent {
    ...
    render() {
        ...
        const outputMarkup = !disabled && output && createElement(
            'output',
            { htmlFor: id, className: styles$62.Output },
            createElement(
                'div',
                { className: styles$62.OutputBubble },
                createElement(
                    'span',
                    { className: styles$62.OutputText },
                    value
                )
            )
        );
        const prefixMarkup = prefix && createElement(
            'div',
            { className: styles$62.Prefix },
            prefix
        );
        const suffixMarkup = suffix && createElement(
            'div',
            { className: styles$62.Suffix },
            suffix
        );
        const className = classNames(styles$62.RangeSlider, error && styles$62.error, disabled && styles$62.disabled);
        return createElement(
            Labelled$1,
            ...
            createElement(
                ...
                createElement(
                    'div',
                    { className: styles$62.InputWrapper },
                    createElement('input', { type: 'range', className: styles$62.Input, id: id, name: id, min: min, max: max, step: step, value: value, disabled: disabled, onChange: this.handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-valuemin': min, 'aria-valuemax': max, 'aria-valuenow': value, 'aria-invalid': Boolean(error), 'aria-describedby': ariaDescribedBy }),
                    outputMarkup
                ),
                suffixMarkup
            )
...
const getUniqueID$10 = createUniqueIDFactory('Select');
function Select$1({ id = getUniqueID$10(), name, groups, options, labelHidden, labelAction, helpText, label, error, value, placeholder, disabled, onChange, onFocus, onBlur }) {
    let optionsMarkup;
    if (options != null) {
    ...
    const className = classNames(styles$63.Select, error && styles$63.error, disabled && styles$63.disabled);
    ...
    const placeholderOption = isPlaceholder && createElement(
        'option',
        { value: PLACEHOLDER_VALUE, disabled: true, hidden: true },
        placeholder
    );
    ...
    return createElement(
        ...
        createElement(
            ...
            createElement(
                'select',
                { id: id, name: name, defaultValue: defaultValue, value: finalValue, className: styles$63.Input, disabled: disabled, onFocus: onFocus, onBlur: onBlur, onChange: handleChange, 'aria-invalid': Boolean(error), 'aria-describedby': describedBy.length ? describedBy.join(' ') : undefined },
                placeholderOption,
                optionsMarkup
            ),
            createElement(
            ...
            createElement('div', { className: styles$63.Backdrop })
        )
    );
}
...
var styles$64 = {
  "CheckableButton": "p_tm",
  "CheckableButton-measuring": "p_f9",
  "CheckableButton-plain": "p_kg",
  "CheckableButton-selectMode": "p_rv",
  "CheckableButton-selected": "p_ti",
  "Checkbox": "p_s7",
  "Label": "p_bk",
};

function CheckableButton$1({ accessibilityLabel, label = '', onToggleAll, selected, selectMode, plain, measuring }) {
    const className = plain ? classNames(styles$64.CheckableButton, styles$64['CheckableButton-plain']) : classNames(styles$64.CheckableButton, selectMode && styles$64['CheckableButton-selectMode'], selected && styles$64['CheckableButton-selected'], measuring && styles$64['CheckableButton-measuring']);
    return createElement(
        'div',
        { className: className, onClick: onToggleAll },
        createElement(
            'div',
            { className: styles$64.Checkbox },
            createElement(Checkbox$2, { label: accessibilityLabel, labelHidden: true, checked: selected })
        ),
        createElement(
            'span',
            { className: styles$64.Label },
            label
        )
    );
}
    ...
    render() {
        ...
        if (selectable) {
            ...
            handleMarkup = createElement(
                'div',
                { className: styles$65.Handle, onClick: this.handleLargerSelectionArea },
                createElement(
                    'div',
                    { onClick: stopPropagation, className: styles$65.CheckboxWrapper },
        ...
        if (media || selectable) {
            ownedMarkup = createElement(
                'div',
                { className: styles$65.Owned },
                handleMarkup,
                mediaMarkup
            );
        }
        const className = classNames(styles$65.Item, focused && styles$65.focused, selectable && styles$65.selectable, selected && styles$65.selected, selectMode && styles$65.selectMode, persistActions && styles$65.persistActions, focusedInner && styles$65.focusedInner);
        ...
        if (shortcutActions) {
            if (persistActions) {
                actionsMarkup = createElement(
                    'div',
                    { className: styles$65.Actions, onClick: stopPropagation },
                    createElement(
                        ButtonGroup$1,
                        null,
                ...
                disclosureMarkup = createElement(
                    'div',
                    { className: styles$65.Disclosure, onClick: stopPropagation },
                    createElement(
                        Popover$1,
        ...
        const content = children ? createElement(
            'div',
            { className: styles$65.Content },
            children
        ) : null;
        const containerMarkup = createElement(
            'div',
            { className: styles$65.Container, id: this.props.id },
            ownedMarkup,
            content,
            actionsMarkup,
            disclosureMarkup
        );
        const accessibleMarkup = url ? createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$65.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : createElement('button', { className: styles$65.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
        return createElement(
            'div',
...
Item$7.contextTypes = contextTypes;
...
__decorate([autobind], Item$7.prototype, "handleContextUpdate", null);
...
var Item$8 = withAppProvider()(Item$7);
    ...
    render() {
        ...
        switch (filter.type) {
            case FilterType.Select:
                return createElement(Select$1, { label: selectedFilterLabel, options: filter.options, placeholder: intl.translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder'), value: value, onChange: onChange });
            case FilterType.TextField:
                return createElement(TextField$1, { label: selectedFilterLabel, value: value, onChange: onChange });
            default:
                return null;
        }
    }
...
class FilterCreator extends PureComponent {
    ...
    render() {
        ...
        const filterValueSelectionMarkup = selectedFilter ? createElement(FilterValueSelector$1, { filter: selectedFilter, value: selectedFilterValue, onChange: this.handleFilterValueChange }) : null;
        ...
        return createElement(
            Popover$1,
            { active: popoverActive, activator: activator, onClose: this.togglePopover, sectioned: true },
            createElement(
                Form$1,
    ...
    handleAddFilter() {
        ...
        const selectedFilterKey = this.state.selectedFilter && this.state.selectedFilter.key;
...
class FilterControl$1 extends Component {
    render() {
        ...
        const appliedFiltersMarkup = appliedFilters.map(appliedFilter => {
            ...
            return createElement(
                'li',
                { className: styles$66.AppliedFilter, key: filterId },
                createElement(
                    Tag$2,
        ...
        const appliedFiltersWrapper = appliedFilters.length > 0 ? createElement(
            'ul',
            { className: styles$66.AppliedFilters },
    ...
    getFilterLabel({ key, value, label }) {
        if (label) {
            return label;
        }
        const { filters = [] } = this.props;
...
FilterControl$1.contextTypes = contextTypes;
...
function findFilterLabelByType(filter, appliedFilterValue) {
...
var styles$67 = {
  "Button": "p_n1",
  "Group-measuring": "p_rt",
  "Group": "p_w8",
  "Group-entering": "p_g1",
  "Group-exiting": "p_g2",
  "Group-entered": "p_jn",
  "Group-exited": "p_vp",
  "Group-smallScreen": "p_ph",
  "Group-largeScreen": "p_j7",
  "ButtonGroup": "p_px",
  "Button-cancel": "p_fk",
  "Popover": "p_rd",
  "ActionContent": "p_h9",
  "ActionIcon": "p_ot",
  "disabled": "p_tb",
  "PaginatedSelectAll": "p_zp",
  "Slide": "p_l7",
  "Slide-appear": "p_bv",
  "Slide-enter": "p_na",
  "Slide-exit": "p_zv",
  "Slide-appearing": "p_g0",
  "Slide-entering": "p_bc",
};
...
class BulkActionButton extends PureComponent {
    ...
    render() {
        ...
        const disclosureIconMarkup = disclosure ? createElement(
            'span',
            { className: styles$67.ActionIcon },
            createElement(Icon$2, { source: 'caretDown' })
        ) : null;
        const contentMarkup = disclosureIconMarkup ? createElement(
            'span',
            { className: styles$67.ActionContent },
            createElement(
                'span',
                null,
                content
        ...
        if (url) {
            return createElement(
                UnstyledLink$2,
                { external: external, url: url, onMouseUp: handleMouseUpByBlurring, className: styles$67.Button, 'aria-label': accessibilityLabel },
                contentMarkup
            );
        }
        const className = classNames$1(styles$67.Button, disabled && styles$67.disabled);
        return createElement(
            'button',
...
const slideClasses = {
    appear: classNames(styles$67.Slide, styles$67['Slide-appear']),
    appearActive: classNames(styles$67.Slide, styles$67['Slide-appearing']),
    enter: classNames(styles$67.Slide, styles$67['Slide-enter']),
    enterActive: classNames(styles$67.Slide, styles$67['Slide-entering']),
    exit: classNames(styles$67.Slide, styles$67['Slide-exit'])
};
class BulkActions$1 extends PureComponent {
    ...
    render() {
        ...
        const paginatedSelectAllMarkup = paginatedSelectAllActionMarkup || paginatedSelectAllTextMarkup ? createElement(
            'div',
            { className: styles$67.PaginatedSelectAll },
            paginatedSelectAllTextMarkup,
            ' ',
            paginatedSelectAllActionMarkup
        ) : null;
        const cancelButtonClassName = classNames(styles$67.Button, styles$67['Button-cancel']);
        ...
        const allActionsPopover = this.hasActions ? createElement(
            'div',
            { className: styles$67.Popover, ref: this.setMoreActionsNode },
            createElement(
                Popover$1,
        ...
        const smallScreenGroup = createElement(
            ...
            status => {
                const smallScreenGroupClassName = classNames(styles$67.Group, styles$67['Group-smallScreen'], styles$67[`Group-${status}`]);
                return createElement(
                    'div',
                    { className: smallScreenGroupClassName },
                    createElement(
                        'div',
                        { className: styles$67.ButtonGroup },
                        createElement(
                            CSSTransition,
        ...
        const largeScreenGroup = createElement(
            ...
            status => {
                const largeScreenGroupClassName = classNames(styles$67.Group, styles$67['Group-largeScreen'], !measuring && styles$67[`Group-${status}`], measuring && styles$67['Group-measuring']);
                return createElement(
                    'div',
                    ...
                    createElement(
                        'div',
                        { className: styles$67.ButtonGroup, ref: this.setLargeScreenButtonsNode },
                        createElement(CheckableButton$2, checkableButtonProps),
...
var styles$68 = {
  "FiltersWrapper": "p_k3",
  "ResourceList": "p_og",
  "HeaderOuterWrapper": "p_vl",
  "HeaderWrapper": "p_t5",
  "HeaderWrapper-isSticky": "p_cl",
  "HeaderContentWrapper": "p_i4",
  "HeaderWrapper-inSelectMode": "p_h8",
  "SortWrapper": "p_vb",
  "HeaderWrapper-hasSelect": "p_sz",
  "HeaderWrapper-hasSort": "p_xo",
  "SortLabel": "p_iv",
  "ItemCountTextWrapper": "p_ed",
  "BulkActionsWrapper": "p_yr",
  "CheckableButtonWrapper": "p_br",
  "SelectButtonWrapper": "p_pf",
  "EmptySearchResultWrapper": "p_ja",
  "ResourceListWrapper": "p_iq",
  "ItemWrapper": "p_ez",
};

const SMALL_SCREEN_WIDTH = 458;
const getUniqueID$9 = createUniqueIDFactory('Select');
class ResourceList$1 extends Component {
    ...
    render() {
        ...
        const filterControlMarkup = filterControl ? createElement(
            'div',
            { className: styles$68.FiltersWrapper },
            filterControl
        ) : null;
        const bulkActionsMarkup = this.selectable ? createElement(
            'div',
            { className: styles$68.BulkActionsWrapper },
        ...
        const itemCountTextMarkup = createElement(
            'div',
            { className: styles$68.ItemCountTextWrapper },
            this.itemCountText
        );
        const selectButtonMarkup = this.selectable ? createElement(
            'div',
            { className: styles$68.SelectButtonWrapper },
            createElement(
                Button$2,
        ...
        const checkableButtonMarkup = this.selectable ? createElement(
            'div',
            { className: styles$68.CheckableButtonWrapper },
        ...
        const headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && createElement(
            'div',
            { className: styles$68.HeaderOuterWrapper },
            createElement(
                Sticky$1,
                { boundingElement: listNode },
                isSticky => {
                    const headerClassName = classNames(styles$68.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$68['HeaderWrapper-hasSort'], this.selectable && styles$68['HeaderWrapper-hasSelect'], this.selectable && selectMode && styles$68['HeaderWrapper-inSelectMode'], isSticky && styles$68['HeaderWrapper-isSticky']);
                    return createElement(
                        'div',
                        { className: headerClassName },
                        createElement(
                            'div',
                            { className: styles$68.HeaderContentWrapper },
                            itemCountTextMarkup,
        ...
        const emptyStateMarkup = filterControl && !itemsExist ? createElement(
            'div',
            { className: styles$68.EmptySearchResultWrapper },
        ...
        const listMarkup = itemsExist ? createElement(
            'ul',
            { className: styles$68.ResourceList, ref: this.setListNode, 'aria-live': 'polite' },
            items.map(this.renderItem)
        ) : emptyStateMarkup;
        return createElement(
            'div',
            { className: styles$68.ResourceListWrapper },
            filterControlMarkup,
            headerMarkup,
            listMarkup
        );
    ...
    renderItem(item, index) {
        ...
        return createElement(
            'li',
            { key: id, className: styles$68.ItemWrapper },
            renderItem(item, id)
        );
    }
...
ResourceList$1.childContextTypes = contextTypes;
...
var styles$69 = {
  ...
  "Item": "p_qv",
  "DisclosureTab": "p_si",
  "DisclosureTab-visible": "p_d1",
  "DisclosureActivator": "p_b4",
  "TabMeasurer": "p_s2",
};

class Item$9 extends PureComponent {
    constructor() {
        super(...arguments);
    ...
    render() {
        ...
        const className = classNames(styles$69.Item);
        return createElement(
            'li',
            { role: 'presentation' },
            createElement(
...
class List$1 extends PureComponent {
    render() {
        ...
        return createElement(
            'ul',
            { className: styles$69.List, onKeyDown: handleKeyDown$2, onKeyUp: this.handleKeypress },
            tabs
        );
    }
    handleKeypress(event) {
...
class Tab extends PureComponent {
    ...
    render() {
        ...
        const className = classNames(styles$69.Tab, selected && styles$69['Tab-selected']);
        let tabIndex;
        ...
        return createElement(
            'li',
            { role: 'presentation', className: styles$69.TabContainer, ref: this.setNode },
            markup
        );
    }
    setNode(node) {
...
class TabMeasurer extends PureComponent {
    ...
    render() {
        ...
        const classname = classNames(styles$69.Tabs, styles$69.TabMeasurer);
        return createElement(
            'div',
...
function Panel({ id, tabID, children }) {
  return createElement(
    'div',
    { className: styles$69.Panel, id: id, role: 'tabpanel', 'aria-labelledby': tabID, tabIndex: -1 },
    children
  );
}
...
class Tabs$1 extends PureComponent {
    ...
    render() {
        ...
        const classname = classNames(styles$69.Tabs, fitted && styles$69.fitted, disclosureActivatorVisible && styles$69.fillSpace);
        const disclosureTabClassName = classNames(styles$69.DisclosureTab, disclosureActivatorVisible && styles$69['DisclosureTab-visible']);
        const activator = createElement(
            'button',
            { tabIndex: -1, className: styles$69.DisclosureActivator, onClick: this.handleDisclosureActivatorClick },
    ...
    handleFocus(event) {
        ...
        const target$$1 = event.target;
        if (target$$1.classList.contains(styles$69.Tab) || target$$1.classList.contains(styles$69.Item)) {
            let tabToFocus = -1;
        ...
        if (target$$1.classList.contains(styles$69.DisclosureActivator)) {
            return;
        }
        ...
        if (!relatedTarget.classList.contains(styles$69.Tab) && !relatedTarget.classList.contains(styles$69.Item) && !relatedTarget.classList.contains(styles$69.DisclosureActivator)) {
            this.setState({ tabToFocus: selected });
        }
    }
    handleBlur(event) {
...
function Tag$1({ children, disabled = false, onRemove, polaris: { intl } }) {
  const className = classNames$1(disabled && styles$70.disabled, styles$70.Tag);
  ...
  return createElement(
    ...
    createElement(
      'button',
      { type: 'button', 'aria-label': ariaLabel, className: styles$70.Button, onClick: onRemove, onMouseUp: handleMouseUpByBlurring, disabled: disabled },
...
class Resizer extends PureComponent {
    ...
    render() {
        ...
        const minimumLinesMarkup = minimumLines ? createElement('div', { ref: this.setMinimumLinesNode, className: styles$71.DummyInput, dangerouslySetInnerHTML: {
                __html: getContentsForMinimumLines(minimumLines)
            } }) : null;
        return createElement(
            'div',
            { 'aria-hidden': true, className: styles$71.Resizer },
            createElement(EventListener$1, { event: 'resize', handler: this.handleHeightCheck }),
            createElement('div', { ref: this.setContentNode, className: styles$71.DummyInput, dangerouslySetInnerHTML: { __html: getFinalContents(contents) } }),
            minimumLinesMarkup
        );
    }
    handleHeightCheck() {
...
function Spinner$3({ onChange, onClick }) {
  function handleStep(step) {
    return () => onChange(step);
  }
  return createElement(
    'div',
    { className: styles$71.Spinner, onClick: onClick, 'aria-hidden': true },
    createElement(
      'div',
      { role: 'button', className: styles$71.Segment, tabIndex: -1, onClick: handleStep(1) },
      createElement(
        'div',
        { className: styles$71.SpinnerIcon },
...
const getUniqueID$11 = createUniqueIDFactory('TextField');
class TextField$1 extends PureComponent {
    ...
    render() {
        const { id = this.state.id, value = '', placeholder, disabled, readOnly, autoFocus, type, name, error, multiline, connectedRight, connectedLeft, label, labelAction, labelHidden, helpText, prefix, suffix, onFocus, onBlur, autoComplete, min, max, minLength, maxLength, spellCheck, pattern } = this.props;
        const { height } = this.state;
        const className = classNames(styles$71.TextField, Boolean(value) && styles$71.hasValue, disabled && styles$71.disabled, readOnly && styles$71.readOnly, error && styles$71.error, multiline && styles$71.multiline, this.state.focus && styles$71.focus);
        const inputType = type === 'currency' ? 'text' : type;
        const prefixMarkup = prefix ? createElement(
            'div',
            { className: styles$71.Prefix, id: `${id}Prefix` },
            prefix
        ) : null;
        const suffixMarkup = suffix ? createElement(
            'div',
            { className: styles$71.Suffix, id: `${id}Suffix` },
            suffix
        ) : null;
        const spinnerMarkup = type === 'number' && !disabled ? createElement(Spinner$3, { onChange: this.handleNumberChange }) : null;
        ...
        const inputClassName = classNames(styles$71.Input, suffix && styles$71['Input-suffixed']);
        ...
        return createElement(
            ...
            createElement(
                ...
                createElement(
                    ...
                    suffixMarkup,
                    spinnerMarkup,
                    createElement('div', { className: styles$71.Backdrop }),
                    resizer
                )
            )
        );
...
function Thumbnail$1({ source, alt, size = 'medium' }) {
    const className = classNames(styles$72.Thumbnail, size && styles$72[variationName('size', size)]);
    return createElement(
        'span',
        { className: className },
        createElement(Image$1, { alt: alt, source: source, className: styles$72.Image })
    );
}
...
class TooltipOverlay extends PureComponent {
    ...
    renderTooltip(overlayDetails) {
        ...
        const containerClassName = classNames(styles$73.Tooltip, light && styles$73.light, measuring && styles$73.measuring, positioning === 'above' && styles$73.positionedAbove);
        const contentStyles = measuring ? undefined : { maxHeight: desiredHeight };
        const tipMarkup = !measuring ? createElement('div', { style: tipStyle, className: styles$73.Tip }) : null;
        return createElement(
            'div',
...
const getUniqueID$12 = createUniqueIDFactory('TooltipContent');
...
function SkeletonDisplayText$1({ size = 'medium' }) {
    const className = classNames(styles$74.DisplayText, size && styles$74[variationName('size', size)]);
    return createElement('div', { className: className });
}

var styles$75 = {
  "SkeletonBodyTextContainer": "p_x8",
  "SkeletonBodyText": "p_y2",
};

function SkeletonBodyText$1({ lines = 3 }) {
    const bodyTextLines = [];
    for (let i = 0; i < lines; i++) {
        bodyTextLines.push(createElement('div', { className: styles$75.SkeletonBodyText, key: i }));
    }
    return createElement(
        'div',
        { className: styles$75.SkeletonBodyTextContainer },
        bodyTextLines
    );
}
...
var styles$76 = {
  ...
  "Content": "p_ow",
  "Header": "p_lh",
  "Header-hasSecondaryActions": "p_uj",
  "Actions": "p_nj",
  "Action": "p_bd",
};
...
class SkeletonPage extends PureComponent {
    render() {
        ...
        const className = classNames(styles$76.Page, fullWidth && styles$76.fullWidth);
        const headerClassName = classNames(styles$76.Header, secondaryActions && styles$76['Header-hasSecondaryActions'], breadcrumbs && styles$76['Header-hasBreadcrumbs']);
...
function renderSecondaryActions(actionCount) {
    ...
    for (let i = 0; i < actionCount; i++) {
        ...
        actions.push(createElement(
            'div',
            { className: styles$76.Action, style: { width }, key: i },
            createElement(SkeletonBodyText$1, { lines: 1 })
        ));
    }
    return createElement(
        'div',
        { className: styles$76.Actions },
        actions
    );
}
...
function ProgressBar$1({ progress = 0, size = 'medium', polaris: { intl } }) {
    const className = classNames(styles$77.ProgressBar, size && styles$77[variationName('size', size)]);
    ...
    return createElement(
        'div',
        { className: className },
        createElement('progress', { className: styles$77.Progress, value: parsedProgress, max: '100' }),
        createElement(
            'div',
            { className: styles$77.Indicator, role: 'progressbar', 'aria-hidden': 'true', style: { width: `${parsedProgress}%` } },
            createElement(
                'span',
                { className: styles$77.Label },
                parsedProgress,
                '%'
            )
        )
