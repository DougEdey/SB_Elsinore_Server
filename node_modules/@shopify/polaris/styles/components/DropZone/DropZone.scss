...
$dropzone-border-width: rem(2px);
$dropzone-border-style: dashed;
$dropzone-border-color: color('sky');
$dropzone-border-color-error: color('red');
...
.Polaris-DropZone--isDragging {
  ...
  background: $dropzone-overlay-background;
}

.Polaris-DropZone--hasError {
  border-color: $dropzone-border-color-error;
  background: $dropzone-overlay-background-error;
}
...
.Polaris-DropZone__Overlay {
  ...
  border: $dropzone-border-width $dropzone-border-style $dropzone-overlay-color;
  border-radius: $dropzone-border-radius;
  text-align: center;
