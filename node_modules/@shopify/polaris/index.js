...
function ButtonGroup$1(_ref) {
    ...
    var className = styles.classNames(styles$6.ButtonGroup, segmented && styles$6.segmented);
...
function Header(_ref) {
    ...
    var childrenMarkup = React.isValidElement(children) ? children : React.createElement(
        Heading$1,
        null,
        children
    );
...
function TextStyle$1(_ref) {
    ...
    var className = styles.classNames(variation && styles$12[styles.variationName('variation', variation)]);
    return React.createElement(
        'span',
        { className: className },
        children
...
function Item$3(_ref) {
  ...
  var className = reactUtilities.classNames(styles$16.Item, disabled && styles$16.disabled);
...
function Section$1(_ref) {
    ...
    var actionMarkup = section.items.map(function (_a, index) {
        ...
        return React.createElement(Item$3, Object.assign({ key: content + '-' + index, content: content, onAction: handleAction(onAction) }, item));
    });
...
function Choice$1(_ref) {
  ...
  var className = styles.classNames(styles$21.Choice, labelHidden && styles$21.labelHidden);
...
function Checkbox$1(_ref) {
    ...
    var wrapperClassName = styles.classNames(styles$22.Checkbox, error && styles$22.error);
    ...
    var inputClassName = styles.classNames(styles$22.Input, isIndeterminate && styles$22['Input-indeterminate']);
    return (
        ...
        React.createElement(
            ...
            React.createElement(
                ...
                React.createElement('span', { className: styles$22.Backdrop }),
                React.createElement(
                    'span',
...
function RadioButton$1(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('input', { id: id, name: name, value: value, type: 'radio', checked: checked, disabled: disabled, className: styles$23.Input, onChange: handleChange, onFocus: onFocus, onBlur: onBlur, 'aria-describedby': describedBy }),
            React.createElement('span', { className: styles$23.Backdrop }),
            React.createElement('span', { className: styles$23.Icon })
        )
    );
}
...
var styles$24 = {
  ...
  "Error": "Polaris-ChoiceList__Error",
  "ErrorIcon": "Polaris-ChoiceList__ErrorIcon",
};

var getUniqueID$1 = other.createUniqueIDFactory('ChoiceList');
var getUniqueErrorID = other.createUniqueIDFactory('Error');
function ChoiceList$1(_ref) {
    ...
    var className = styles.classNames(styles$24.ChoiceList, titleHidden && styles$24.titleHidden);
...
var Collapsible$1 = function (_React$Component) {
    ...
    _createClass(Collapsible, [{
        ...
        value: function render() {
            ...
            var wrapperClassName = styles.classNames(styles$25.Collapsible, open && styles$25.open, animating && styles$25.animating);
    ...
    _createClass(Slidable, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                touchEndListener,
                touchCancelListener,
                React.createElement('div', { style: draggerPositioning, className: styles$26.Dragger, ref: this.setDraggerNode })
            );
        }
    }, {
        key: 'setDraggerNode',
    ...
    _createClass(AlphaPicker, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement('div', { className: styles$26.ColorLayer, style: { background: background } }),
                React.createElement(Slidable, { draggerY: draggerY, draggerX: 0, onChange: this.handleChange, onDraggerHeight: this.setDraggerHeight })
            );
        }
    }, {
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('div', { className: styles$26.ColorLayer, style: { backgroundColor: colorString } }),
...
var Item$4 = function (_React$PureComponent) {
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$27.Item, focused && styles$27['Item-focused'], position === Position.Primary ? styles$27['Item-primary'] : styles$27['Item-connection']);
            return React.createElement(
                'div',
...
var styles$28 = {
  ...
  "Cell-presentational": "Polaris-DataTable__Cell--presentational",
  ...
  "Heading-sortable": "Polaris-DataTable__Heading--sortable",
...
function Cell(_ref) {
    var height = _ref.height,
        ...
        presentational = _ref.presentational,
        header = _ref.header,
        total = _ref.total,
        footer = _ref.footer,
        sorted = _ref.sorted,
    ...
    var className = styles.classNames(styles$28.Cell, fixed && styles$28['Cell-fixed'], fixed && truncate && styles$28['Cell-truncated'], presentational && styles$28['Cell-presentational'], header && styles$28['Cell-header'], total && styles$28['Cell-total'], footer && styles$28['Cell-footer'], numeric && styles$28['Cell-numeric'], sorted && styles$28['Cell-sorted'], sortable && styles$28['Cell-sortable']);
    var style = height ? { height: height + 'px' } : undefined;
    var headerClassName = styles.classNames(header && styles$28.Heading, header && contentType === 'text' && styles$28['Heading-left']);
    var iconClassName = styles.classNames(sortable && styles$28['Heading-sortable']);
    // TODO work out a better way for fix this lint violation
    var presentationalMarkup = header ?
    // eslint-disable-next-line jsx-a11y/no-interactive-element-to-noninteractive-role
    React.createElement('th', { 'aria-hidden': true, role: 'presentation', className: className, style: style }) :
    // eslint-disable-next-line jsx-a11y/no-interactive-element-to-noninteractive-role
    React.createElement('td', { 'aria-hidden': true, role: 'presentation', className: className, style: style });
    var sortedIconMarkup = null;
    var sortableIconMarkup = null;
    var sortAccessibilityLabel = void 0;
    if (sortable) {
        ...
        if (sorted) {
            var direction = sortDirection === 'ascending' ? 'Up' : 'Down';
            var source = 'caret' + direction;
            sortedIconMarkup = React.createElement(Icon$2, { source: source });
        } else {
            var _direction = defaultSortDirection === 'ascending' ? 'Up' : 'Down';
            var _source = 'caret' + _direction;
            sortableIconMarkup = React.createElement(Icon$2, { source: _source });
        }
    }
    var sortableHeadingContent = contentType === 'text' ? React.createElement(
        'span',
    ...
    var nonPresentationalMarkup = header || fixed ? headingMarkup : React.createElement(
        'td',
        { className: className, style: style },
        content
    );
    var cellMarkup = presentational ? presentationalMarkup : nonPresentationalMarkup;
    return cellMarkup;
}
...
function Navigation(_ref) {
    var currentColumn = _ref.currentColumn,
        columnVisibilityData = _ref.columnVisibilityData,
    ...
    var pipMarkup = columnVisibilityData.map(function (column, index) {
        var className = styles.classNames(styles$28.Pip, column.isVisible && styles$28['Pip-visible']);
    ...
    return React.createElement(
        ...
        React.createElement(Button$2, { plain: true, icon: 'chevronLeft', disabled: reachedTableEnd('left'), accessibilityLabel: 'Scroll table left one column', onClick: navigateTableLeft }),
        pipMarkup,
        React.createElement(Button$2, { plain: true, icon: 'chevronRight', disabled: reachedTableEnd('right'), accessibilityLabel: 'Scroll table right one column', onClick: navigateTableRight })
    );
}
    ...
    _createClass(DataTable, [{
        ...
        value: function render() {
            ...
            var _state = this.state,
                ...
                currentColumn = _state.currentColumn,
            ...
            var className = styles.classNames(styles$28.DataTable, collapsed && styles$28.collapsed, footerContent && styles$28.hasFooter);
            var wrapperClassName = styles.classNames(styles$28.TableWrapper, collapsed && styles$28.collapsed);
            var footerClassName = styles.classNames(footerContent && styles$28.TableFoot);
            ...
            var headingMarkup = React.createElement(
                'tr',
                null,
                insertPresentationalCell(headings).map(function (heading, headingIndex) {
                    ...
                    var index = headingIndex <= 1 ? headingIndex : headingIndex - 1;
                    var contentTypes = _this3.getContentTypes();
                    if (sortable) {
                        var isSortable = sortable[index];
                        var isSorted = isSortable && sortedColumnIndex === index;
                        var direction = isSorted && sortedColumnIndex === index ? sortDirection : 'none';
                        sortableHeadingProps = {
                            defaultSortDirection: defaultSortDirection,
                            sorted: isSorted,
                            sortable: isSortable,
                            sortDirection: direction,
                            onSort: _this3.defaultOnSort(index)
                        };
                    }
                    var height = !truncate ? heights[0] : undefined;
                    return React.createElement(Cell$1, Object.assign({ header: true, key: id, height: height, content: heading, contentType: contentTypes[headingIndex], fixed: headingIndex === 0, truncate: truncate, presentational: headingIndex === 1 }, sortableHeadingProps));
                })
            );
            var bodyMarkup = rows.map(this.defaultRenderRow);
            var style = footerContent ? { marginBottom: heights[heights.length - 1] + 'px' } : {};
            return React.createElement(
                'div',
                { className: wrapperClassName },
                React.createElement(Navigation, { currentColumn: currentColumn, columnVisibilityData: columnVisibilityData, navigateTableLeft: this.navigateTable('left'), navigateTableRight: this.navigateTable('right') }),
                React.createElement(
                    'div',
        ...
        value: function handleResize() {
            ...
            var collapsed = this.table.scrollWidth > this.dataTable.offsetWidth;
        ...
        value: function calculateColumnVisibilityData(collapsed) {
            if (collapsed) {
                ...
                var collapsedHeaderCells = Array.from(headerCells).slice(2);
                ...
                return Object.assign({ columnVisibilityData: columnVisibilityData }, getPrevAndCurrentColumns(tableData, columnVisibilityData));
            }
            return {
                columnVisibilityData: [],
        ...
        value: function getContentTypes() {
            var columnContentTypes = this.props.columnContentTypes;

            var fixedCellType = columnContentTypes[0];
            return [fixedCellType].concat(_toConsumableArray(columnContentTypes));
        }
    }, {
        key: 'renderFirstTwoTotalsCells',
        value: function renderFirstTwoTotalsCells(index) {
            var height = void 0;
            ...
            if (index === 0) {
                return React.createElement(Cell$1, { fixed: true, total: true, key: id, height: height, content: this.totalsRowHeading, truncate: truncate });
            }
            if (index === 1) {
                return React.createElement(Cell$1, { key: id, presentational: true, height: height });
            }
            return React.createElement(Cell$1, { total: true, key: id, contentType: 'numeric', height: height });
        }
    }, {
        key: 'renderTotals',
        value: function renderTotals(total, index) {
            ...
            var id = 'totals-cell-' + index;
            var heights = this.state.heights;
            var _props$truncate2 = this.props.truncate,
                truncate = _props$truncate2 === undefined ? false : _props$truncate2;

            if (!truncate) {
                height = heights[1];
            }
            return total === '' ? this.renderFirstTwoTotalsCells(index) : React.createElement(Cell$1, { total: true, key: id, height: height, contentType: 'numeric', content: total });
        }
    }, {
        key: 'defaultRenderRow',
        value: function defaultRenderRow(row, index) {
            var className = styles.classNames(styles$28.TableRow);
            ...
            return React.createElement(
                ...
                insertPresentationalCell(row).map(function (content, cellIndex) {
                    var id = 'cell-' + cellIndex + '-row-' + index;
                    return React.createElement(Cell$1, { key: id, height: bodyCellHeights[index], content: content, contentType: contentTypes[cellIndex], fixed: cellIndex === 0, truncate: truncate, presentational: cellIndex === 1 });
                })
            );
        }
    }, {
        ...
        value: function renderFooter() {
            ...
            return React.createElement(Cell$1, { footer: true, height: footerCellHeight, content: this.props.footerContent, truncate: this.props.truncate });
        }
    }, {
        key: 'defaultOnSort',
...
tslib_1.__decorate([decorators.autobind], DataTable$1.prototype, "getContentTypes", null);
tslib_1.__decorate([decorators.autobind], DataTable$1.prototype, "renderFirstTwoTotalsCells", null);
...
function insertPresentationalCell() {
    var arr = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

    var fixedCell = arr[0];
    var presentationalCell = '';
    return [fixedCell, presentationalCell].concat(_toConsumableArray(arr.slice(1)));
}
function measureColumn(tableData) {
    return function (column, index) {
        var tableLeftVisibleEdge = tableData.tableLeftVisibleEdge,
            tableRightVisibleEdge = tableData.tableRightVisibleEdge,
            firstVisibleColumnIndex = tableData.firstVisibleColumnIndex,
        ...
        var leftEdgeIsVisible = isEdgeVisible(leftEdge, tableLeftVisibleEdge, tableRightVisibleEdge);
        var rightEdgeIsVisible = isEdgeVisible(rightEdge, tableLeftVisibleEdge, tableRightVisibleEdge);
        var isCompletelyVisible = leftEdge < tableLeftVisibleEdge && rightEdge > tableRightVisibleEdge;
        var isVisible = isCompletelyVisible || leftEdgeIsVisible || rightEdgeIsVisible;
        if (isVisible) {
...
function getPrevAndCurrentColumns(tableData, columnData) {
    var tableRightVisibleEdge = tableData.tableRightVisibleEdge,
        tableLeftVisibleEdge = tableData.tableLeftVisibleEdge,
        firstVisibleColumnIndex = tableData.firstVisibleColumnIndex;

    var previousColumnIndex = Math.max(firstVisibleColumnIndex - 1, 0);
    var previousColumn = columnData[previousColumnIndex];
    var lastColumnIndex = columnData.length - 1;
    var lastColumn = columnData[lastColumnIndex];
    var currentColumn = Object.assign({ isScrolledFarthestLeft: firstVisibleColumnIndex === 0 && tableLeftVisibleEdge === 0, isScrolledFarthestRight: lastColumn.rightEdge <= tableRightVisibleEdge }, columnData[firstVisibleColumnIndex]);
...
var Day = function (_React$PureComponent) {
    ...
    _createClass(Day, [{
        ...
        value: function render() {
            ...
            if (!day) {
                return React.createElement('div', { className: styles$29.EmptyDay, onMouseOver: handleHover });
            }
            var handleClick = onClick && !disabled ? onClick.bind(null, day) : other.noop;
            var today = dates.isSameDay(new Date(), day);
            var className = styles.classNames(styles$29.Day, selected && styles$29['Day-selected'], disabled && styles$29['Day-disabled'], today && styles$29['Day-today'], (inRange || inHoveringRange) && !disabled && styles$29['Day-inRange']);
...
function Weekday(_ref) {
    ...
    var className = styles.classNames(styles$29.Weekday, current && styles$29['Weekday-current']);
    return React.createElement(
        'div',
...
function Month(_ref) {
    ...
    var className = styles.classNames(styles$29.Title, current && styles$29['Month-current']);
    ...
    function renderWeek(day, dayIndex) {
        if (day == null) {
            ...
            return (
                // eslint-disable-next-line react/jsx-no-bind
                React.createElement(Day$1, { key: dayIndex, onHover: onHover.bind(null, lastDayOfMonth) })
            );
        }
        ...
        return React.createElement(Day$1, { focused: focusedDate != null && dates.isSameDay(day, focusedDate), day: day, key: dayIndex, onFocus: onFocus, onClick: handleDateClick, onHover: onHover, selected: selected != null && dates.dateIsSelected(day, selected), inRange: selected != null && dates.dateIsInRange(day, selected), disabled: disabled, inHoveringRange: selected != null && hoverDate != null && isInHoveringRange(day, selected, hoverDate) });
    }
...
var DatePicker$1 = function (_React$PureComponent) {
    ...
    _createClass(DatePicker, [{
        ...
        value: function getDerivedStateFromProps(nextProps, prevState) {
            ...
            if (range != null && prevState.range != null && dates.isSameDay(range.start, prevState.range.start) && dates.isSameDay(range.end, prevState.range.end)) {
                return null;
            }
            return {
                range: range,
...
function DisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$31.DisplayText, size && styles$31[styles.variationName('size', size)]);
    return React.createElement(
        Element,
        { className: className },
        children
...
var FileUpload$1 = function (_React$Component) {
    ...
    _createClass(FileUpload, [{
        ...
        value: function render() {
            ...
            var imageClasses = styles.classNames(styles$33.Image, size && size === 'extraLarge' && styles$33.sizeExtraLarge, size && size === 'large' && styles$33.sizeLarge);
    ...
    _createClass(DropZone, [{
        ...
        value: function render() {
            var _state2 = this.state,
                ...
                error = _state2.error,
                size = _state2.size,
                overlayText = _state2.overlayText,
                errorOverlayText = _state2.errorOverlayText;
            var _props = this.props,
                children = _props.children,
                disabled = _props.disabled,
            ...
            var classes = styles.classNames(styles$34.DropZone, outline && styles$34.hasOutline, (active || dragging) && styles$34.isDragging, error && styles$34.hasError, size && size === 'extraLarge' && styles$34.sizeExtraLarge, size && size === 'large' && styles$34.sizeLarge, size && size === 'medium' && styles$34.sizeMedium, size && size === 'small' && styles$34.sizeSmall);
...
var EmptySearchResult$1 = function (_React$PureComponent) {
    ...
    _createClass(EmptySearchResult, [{
        ...
        value: function render() {
            ...
            var illustrationMarkup = withIllustration ? React.createElement(Image$1, { alt: altText, source: emptySearch, className: styles$35.Image, draggable: false }) : null;
            return React.createElement(
                Stack$1,
...
var EmptyState$1 = function (_React$PureComponent) {
  ...
  _createClass(EmptyState, [{
    ...
    value: function render() {
      ...
      var className = styles.classNames(styles$36.EmptyState, imageContained && styles$36.imageContained);
      var imageMarkup = largeImage ? React.createElement(Image$1, { alt: '', role: 'presentation', className: styles$36.Image, source: largeImage, sourceSet: [{ source: image, descriptor: '568w' }, { source: largeImage, descriptor: '1136w' }], sizes: '(max-width: 568px) 60vw' }) : React.createElement(Image$1, { role: 'presentation', alt: '', className: styles$36.Image, source: image });
      var secondaryActionMarkup = secondaryAction ? buttonFrom(secondaryAction, { plain: true }) : null;
      return React.createElement(
        'div',
        { className: className },
...
function ExceptionList$1(_ref) {
  ...
  var items = itemsList.map(function (item, index) {
    ...
    var itemClasses = styles.classNames(styles$38.Item, status && styles$38[styles.variationName('status', status)]);
    var iconMarkup = icon ? React.createElement(Icon$2, { source: icon }) : React.createElement('span', { className: styles$38.Bullet });
    var titleMarkup = title && React.createElement(
      'span',
            ...
            fastdom.write(function () {
                ...
                if (root) {
                    if (!root.querySelector('[autofocus]')) {
                        focus.focusFirstFocusableNode(root);
                    }
                }
            });
        }
...
var Form$1 = function (_React$PureComponent) {
    ...
    _createClass(Form, [{
        ...
        value: function render() {
            ...
            var submitMarkup = implicitSubmit && React.createElement('button', { type: 'submit', className: styles$40.submit, 'aria-hidden': 'true' });
            return React.createElement(
                'form',
...
function Label$1(_ref) {
    ...
    var className = styles.classNames(styles$43.Label, hidden && styles$43.hidden);
    return React.createElement(
        'div',
        { className: className },
        React.createElement(
...
function Labelled$1(_a) {
  ...
  var className = styles.classNames(labelHidden && styles$44.hidden);
...
var styles$47 = {
  ...
  "animateScaleIn": "Polaris-Modal-Dialog--animateScaleIn",
};
...
function Dialog$1(_a) {
  ...
  var animation = large ? ScaleIn : FadeUp;
  var TransitionChild = instant ? reactTransitionGroup.Transition : animation;
  return React.createElement(
    TransitionChild,
...
var scaleInClasses = {
  enter: styles.classNames(styles$47.animateScaleIn, styles$47.entering),
  enterActive: styles.classNames(styles$47.animateScaleIn, styles$47.entered),
  exit: styles.classNames(styles$47.animateScaleIn, styles$47.exiting),
  exitActive: styles.classNames(styles$47.animateScaleIn, styles$47.exited)
};
function ScaleIn(_a) {
  var children = _a.children,
      props = tslib_1.__rest(_a, ["children"]);
...
function Section$4(_ref) {
    ...
    var className = styles.classNames(styles$49.Section, flush && styles$49.flush, subdued && styles$49.subdued);
    return React.createElement(
        'section',
        { className: className },
        children
...
var getUniqueID$4 = other.createUniqueIDFactory('modal-header');
    ...
    _createClass(Modal, [{
        ...
        value: function render() {
            ...
            if (open) {
                ...
                var content = sectioned ? components.wrapWithComponent(children, Section$4) : children;
                var body = loading ? React.createElement(
                    'div',
                    { className: styles$51.Spinner },
                    React.createElement(Spinner$2, null)
                ) : content;
                var bodyMarkup = src ? React.createElement('iframe', { title: iframeTitle, src: src, className: styles$51.IFrame, onLoad: this.handleIFrameLoad, style: { height: iframeHeight + 'px' } }) : React.createElement(
                    Scrollable$2,
...
var Option$1 = function (_React$Component) {
    ...
    _createClass(Option, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$52.SingleSelectOption, focused && styles$52.focused, disabled && styles$52.disabled, select && styles$52.select);
            var optionMarkup = allowMultiple ? React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(Checkbox$4, { id: id, value: value, checked: select, disabled: disabled, onChange: this.handleClick })
                ),
                label
            ) : React.createElement(
                'button',
...
var getUniqueID$5 = other.createUniqueIDFactory('Checkbox');
function Checkbox$4(_ref) {
  var _ref$id = _ref.id,
      id = _ref$id === undefined ? getUniqueID$5() : _ref$id,
      _ref$checked = _ref.checked,
      checked = _ref$checked === undefined ? false : _ref$checked,
      disabled = _ref.disabled,
      onChange = _ref.onChange,
  ...
  return React.createElement(
    ...
    React.createElement('input', { id: id, name: name, value: value, type: 'checkbox', checked: checked, disabled: disabled, className: styles$53.Input, 'aria-checked': checked, onChange: onChange }),
        ...
        value: function render() {
            ...
            var optionsMarkup = optionsExist ? normalizedOptions.map(function (_ref2, sectionIndex) {
                ...
                var optionsMarkup = options && options.map(function (option, optionIndex) {
                    ...
                    var id = _this2.id + '-' + sectionIndex + '-' + optionIndex;
                    return React.createElement(Option$1, Object.assign({}, option, { key: id, id: id, section: sectionIndex, index: optionIndex, onClick: _this2.handleClick, select: isSelected, allowMultiple: allowMultiple }));
                });
                return React.createElement(
                    'li',
...
function Pagination$1(_ref) {
  ...
  var className = reactUtilities.classNames(styles$56.Pagination, plain && styles$56.plain);
...
var getUniqueID$7 = other.createUniqueIDFactory('portal-');
...
var Portal$1 = function (_React$PureComponent) {
    ...
    function Portal() {
        ...
        _this.portalId = _this.props.idPrefix !== '' ? _this.props.idPrefix + '-' + getUniqueID$7() : getUniqueID$7();
        return _this;
    }
...
function Pane(_ref) {
    ...
    var className = styles.classNames(styles$59.Pane, fixed && styles$59['Pane-fixed']);
    var content = sectioned ? components.wrapWithComponent(children, Section$5) : children;
...
var PopoverOverlay = function (_React$PureComponent) {
    ...
    _createClass(PopoverOverlay, [{
        ...
        value: function renderPopover(transitionStatus, overlayDetails) {
            ...
            var className = styles.classNames(styles$59.Popover, transitionStatus && animationVariations(transitionStatus), positioning === 'above' && styles$59.positionedAbove, fullWidth && styles$59.fullWidth, measuring && styles$59.measuring);
            this.transitionStatus = transitionStatus;
            var tipMarkup = !measuring ? React.createElement('div', { style: { left: activatorRect.center.x - left }, className: styles$59.Tip }) : null;
            var contentStyles = measuring ? undefined : { height: desiredHeight };
            var contentClassNames = styles.classNames(styles$59.Content, fullHeight && styles$59['Content-fullHeight']);
            ...
            return React.createElement(
                ...
                tipMarkup,
                React.createElement('div', { className: styles$59.FocusTracker
                    // eslint-disable-next-line jsx-a11y/no-noninteractive-tabindex
        ...
        value: function handleClick(event) {
            ...
            var isDescendant = contentNode != null && dom.nodeContainsDescendant(contentNode, target$$1);
...
var getUniqueID$6 = other.createUniqueIDFactory('Popover');
...
function Action(_ref) {
  ...
  var className = reactUtilities.classNames(styles$60.Action, disabled && styles$60.disabled, icon && children == null && styles$60.iconOnly, false && showIndicator && styles$60['Action-outline']);
  return React.createElement(
    'button',
...
var Header$3 = function (_React$PureComponent) {
    ...
    _createClass(Header, [{
        ...
        value: function renderSecondaryActions() {
            ...
            var actionGroupsMarkup = actionGroups.length > 0 ? actionGroups.map(function (_ref) {
                ...
                var detailsClassName = styles.classNames(styles$60.Details, actions && Array.isArray(actions) && actions.length > 0 && styles$60.withActions);
                var detailsMarkup = details ? React.createElement(
                    'div',
...
tslib_1.__decorate([decorators.autobind], Header$3.prototype, "handleRollupToggle", null);
...
var Page$1 = function (_React$PureComponent) {
    ...
    _createClass(Page, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$60.Page, fullWidth && styles$60.fullWidth, singleColumn && styles$60.singleColumn);
            var headerMarkup = this.props.polaris.easdk || !this.hasHeaderContent() ? null : React.createElement(Header$3, rest);
            return React.createElement(
                'div',
                { className: className },
                headerMarkup,
...
var getUniqueID$8 = other.createUniqueIDFactory('RangeSlider');
...
var RangeSlider$1 = function (_React$PureComponent) {
    ...
    _createClass(RangeSlider, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$62.RangeSlider, error && styles$62.error, disabled && styles$62.disabled);
            return React.createElement(
                Labelled$1,
...
function Select$1(_ref) {
    var _ref$id = _ref.id,
        id = _ref$id === undefined ? getUniqueID$10() : _ref$id,
        name = _ref.name,
        groups = _ref.groups,
    ...
    var isPlaceholder = Boolean(!value && placeholder);
    var className = styles.classNames(styles$63.Select, error && styles$63.error, disabled && styles$63.disabled);
    ...
    var placeholderOption = isPlaceholder && React.createElement(
        'option',
    ...
    return React.createElement(
        ...
        React.createElement(
            ...
            React.createElement('div', { className: styles$63.Backdrop })
        )
    );
}
...
function CheckableButton$1(_ref) {
    ...
    var className = plain ? styles.classNames(styles$64.CheckableButton, styles$64['CheckableButton-plain']) : styles.classNames(styles$64.CheckableButton, selectMode && styles$64['CheckableButton-selectMode'], selected && styles$64['CheckableButton-selected'], measuring && styles$64['CheckableButton-measuring']);
    return React.createElement(
        'div',
...
var Item$9 = function (_React$PureComponent) {
    _inherits(Item, _React$PureComponent);
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$65.Item, focused && styles$65.focused, selectable && styles$65.selectable, selected && styles$65.selected, selectMode && styles$65.selectMode, persistActions && styles$65.persistActions, focusedInner && styles$65.focusedInner);
            ...
            var accessibleMarkup = url ? React.createElement(UnstyledLink$2, { 'aria-describedby': this.props.id, 'aria-label': accessibilityLabel, className: styles$65.Link, url: url, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur }) : React.createElement('button', { className: styles$65.Button, 'aria-label': accessibilityLabel, 'aria-controls': ariaControls, 'aria-expanded': ariaExpanded, onClick: this.handleClick, onFocus: this.handleAnchorFocus, onBlur: this.handleFocusedBlur });
            return React.createElement(
                'div',
...
Item$9.contextTypes = contextTypes;
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "setNode", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleAnchorFocus", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleFocusedBlur", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleFocus", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleBlur", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleMouseDown", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleLargerSelectionArea", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleSelection", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleClick", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleKeypress", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleContextUpdate", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleActionsClick", null);
tslib_1.__decorate([decorators.autobind], Item$9.prototype, "handleCloseRequest", null);
function stopPropagation(event) {
    event.stopPropagation();
}
var Item$10 = withAppProvider()(Item$9);
...
var FilterValueSelector = function (_React$PureComponent) {
    ...
    _createClass(FilterValueSelector, [{
        ...
        value: function render() {
            ...
            var selectedFilterLabel = filter.operatorText || '';
            switch (filter.type) {
                case exports.FilterType.Select:
                    return React.createElement(Select$1, { label: selectedFilterLabel, options: filter.options, placeholder: intl.translate('Polaris.ResourceList.FilterValueSelector.selectFilterValuePlaceholder'), value: value, onChange: onChange });
                case exports.FilterType.TextField:
                    return React.createElement(TextField$1, { label: selectedFilterLabel, value: value, onChange: onChange });
                default:
                    return null;
            }
        }
...
var FilterCreator = function (_React$PureComponent) {
    ...
    _createClass(FilterCreator, [{
        ...
        value: function render() {
            ...
            var filterValueSelectionMarkup = selectedFilter ? React.createElement(FilterValueSelector$1, { filter: selectedFilter, value: selectedFilterValue, onChange: this.handleFilterValueChange }) : null;
        ...
        value: function handleAddFilter() {
            ...
            var selectedFilterKey = this.state.selectedFilter && this.state.selectedFilter.key;
...
var FilterControl$1 = function (_React$Component) {
    ...
    _createClass(FilterControl, [{
        ...
        key: 'getFilterLabel',
        value: function getFilterLabel(_ref) {
            var key = _ref.key,
                value = _ref.value,
                label = _ref.label;
            ...
            var filter = filters.find(function (_ref2) {
                var filterKey = _ref2.key;
                return filterKey === key;
            });
            if (!filter) {
                return value;
            }
            var filterLabelByType = findFilterLabelByType(filter, value);
            var filterLabels = [filter.label, filter.operatorText, filterLabelByType];
...
var BulkActionButton = function (_React$PureComponent) {
    ...
    _createClass(BulkActionButton, [{
        ...
        value: function render() {
            ...
            var className = reactUtilities.classNames(styles$67.Button, disabled && styles$67.disabled);
            return React.createElement(
                'button',
...
var slideClasses = {
    appear: styles.classNames(styles$67.Slide, styles$67['Slide-appear']),
    appearActive: styles.classNames(styles$67.Slide, styles$67['Slide-appearing']),
    enter: styles.classNames(styles$67.Slide, styles$67['Slide-enter']),
    enterActive: styles.classNames(styles$67.Slide, styles$67['Slide-entering']),
    exit: styles.classNames(styles$67.Slide, styles$67['Slide-exit'])
};
var BulkActions$1 = function (_React$PureComponent) {
    ...
    _createClass(BulkActions, [{
        ...
        value: function render() {
            ...
            var cancelButtonClassName = styles.classNames(styles$67.Button, styles$67['Button-cancel']);
            ...
            var smallScreenGroup = React.createElement(
                ...
                function (status) {
                    var smallScreenGroupClassName = styles.classNames(styles$67.Group, styles$67['Group-smallScreen'], styles$67['Group-' + status]);
                    return React.createElement(
                        'div',
            ...
            var largeScreenGroup = React.createElement(
                ...
                function (status) {
                    var largeScreenGroupClassName = styles.classNames(styles$67.Group, styles$67['Group-largeScreen'], !measuring && styles$67['Group-' + status], measuring && styles$67['Group-measuring']);
                    return React.createElement(
                        'div',
                        ...
                        React.createElement(
                            'div',
                            { className: styles$67.ButtonGroup, ref: _this2.setLargeScreenButtonsNode },
                            React.createElement(CheckableButton$2, checkableButtonProps),
...
var getUniqueID$9 = other.createUniqueIDFactory('Select');
        ...
        value: function render() {
            ...
            var headerMarkup = (showHeader || needsHeader) && listNode && itemsExist && React.createElement(
                ...
                React.createElement(
                    ...
                    function (isSticky) {
                        var headerClassName = styles.classNames(styles$68.HeaderWrapper, sortOptions && sortOptions.length > 0 && styles$68['HeaderWrapper-hasSort'], _this2.selectable && styles$68['HeaderWrapper-hasSelect'], _this2.selectable && selectMode && styles$68['HeaderWrapper-inSelectMode'], isSticky && styles$68['HeaderWrapper-isSticky']);
                        return React.createElement(
                            'div',
                            { className: headerClassName },
                            React.createElement(
...
var Item$11 = function (_React$PureComponent) {
    _inherits(Item, _React$PureComponent);
    ...
    _createClass(Item, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$69.Item);
            return React.createElement(
                'li',
                { role: 'presentation' },
                React.createElement(
...
tslib_1.__decorate([decorators.autobind], Item$11.prototype, "setFocusedNode", null);
...
var Tab = function (_React$PureComponent) {
    ...
    _createClass(Tab, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$69.Tab, selected && styles$69['Tab-selected']);
            var tabIndex = void 0;
...
var TabMeasurer = function (_React$PureComponent) {
    ...
    _createClass(TabMeasurer, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$69.Tabs, styles$69.TabMeasurer);
            return React.createElement(
                'div',
...
var Tabs$1 = function (_React$PureComponent) {
    ...
    _createClass(Tabs, [{
        ...
        value: function render() {
            ...
            var classname = styles.classNames(styles$69.Tabs, fitted && styles$69.fitted, disclosureActivatorVisible && styles$69.fillSpace);
            var disclosureTabClassName = styles.classNames(styles$69.DisclosureTab, disclosureActivatorVisible && styles$69['DisclosureTab-visible']);
            var activator = React.createElement(
                'button',
...
function Tag$1(_ref) {
  ...
  var className = reactUtilities.classNames(disabled && styles$70.disabled, styles$70.Tag);
...
var Resizer = function (_React$PureComponent) {
    ...
    _createClass(Resizer, [{
        ...
        value: function render() {
            ...
            var minimumLinesMarkup = minimumLines ? React.createElement('div', { ref: this.setMinimumLinesNode, className: styles$71.DummyInput, dangerouslySetInnerHTML: {
            ...
            return React.createElement(
                ...
                React.createElement('div', { ref: this.setContentNode, className: styles$71.DummyInput, dangerouslySetInnerHTML: { __html: getFinalContents(contents) } }),
                minimumLinesMarkup
            );
        }
    }, {
...
var getUniqueID$11 = other.createUniqueIDFactory('TextField');
...
var TextField$1 = function (_React$PureComponent) {
    ...
    _createClass(TextField, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$71.TextField, Boolean(value) && styles$71.hasValue, disabled && styles$71.disabled, readOnly && styles$71.readOnly, error && styles$71.error, multiline && styles$71.multiline, this.state.focus && styles$71.focus);
            ...
            var spinnerMarkup = type === 'number' && !disabled ? React.createElement(Spinner$3, { onChange: this.handleNumberChange }) : null;
            ...
            var inputClassName = styles.classNames(styles$71.Input, suffix && styles$71['Input-suffixed']);
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        ...
                        suffixMarkup,
                        spinnerMarkup,
                        React.createElement('div', { className: styles$71.Backdrop }),
                        resizer
                    )
                )
            );
...
function Thumbnail$1(_ref) {
    ...
    var className = styles.classNames(styles$72.Thumbnail, size && styles$72[styles.variationName('size', size)]);
    return React.createElement(
        'span',
        { className: className },
        React.createElement(Image$1, { alt: alt, source: source, className: styles$72.Image })
    );
}
...
var TooltipOverlay = function (_React$PureComponent) {
    ...
    _createClass(TooltipOverlay, [{
        ...
        value: function renderTooltip(overlayDetails) {
            ...
            var tipMarkup = !measuring ? React.createElement('div', { style: tipStyle, className: styles$73.Tip }) : null;
            return React.createElement(
                'div',
...
var getUniqueID$12 = other.createUniqueIDFactory('TooltipContent');
...
function SkeletonDisplayText$1(_ref) {
    ...
    var className = styles.classNames(styles$74.DisplayText, size && styles$74[styles.variationName('size', size)]);
...
function SkeletonBodyText$1(_ref) {
    ...
    for (var i = 0; i < lines; i++) {
        bodyTextLines.push(React.createElement('div', { className: styles$75.SkeletonBodyText, key: i }));
    }
    return React.createElement(
        'div',
...
var SkeletonPage = function (_React$PureComponent) {
    ...
    _createClass(SkeletonPage, [{
        ...
        value: function render() {
            ...
            var className = styles.classNames(styles$76.Page, fullWidth && styles$76.fullWidth);
            var headerClassName = styles.classNames(styles$76.Header, secondaryActions && styles$76['Header-hasSecondaryActions'], breadcrumbs && styles$76['Header-hasBreadcrumbs']);
...
function renderSecondaryActions(actionCount) {
    ...
    for (var i = 0; i < actionCount; i++) {
        ...
        actions.push(React.createElement(
            'div',
            { className: styles$76.Action, style: { width: width }, key: i },
...
function ProgressBar$1(_ref) {
    ...
    var className = styles.classNames(styles$77.ProgressBar, size && styles$77[styles.variationName('size', size)]);
    ...
    return React.createElement(
        'div',
        { className: className },
        React.createElement('progress', { className: styles$77.Progress, value: parsedProgress, max: '100' }),
        React.createElement(
            'div',
